...
| releases | Release Workflow (7-stage) | `releases` | [feature-registry/releases.md](feature-registry/releases.md) | release-workflow, questionnaire, process-requirements, product-requirements, csrr, fcsr-decision, actions-management | `tests/releases/` | `src/pages/release-detail.page.ts` |
